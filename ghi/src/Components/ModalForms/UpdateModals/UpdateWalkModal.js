...
export default function UpdateWalkRecordModal({ isOpen, onClose, selectedPetId, walk_id }) {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await updateWalkMutation({ updatedWalk, petId: selectedPetId, walk_id: walk_id }).unwrap();
            console.log(walk_id)
