...
export default function UpdateSleepRecordModal({ isOpen, onClose, selectedPetId, sleep_id }) {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await updateSleepMutation({ updatedSleep, petId: selectedPetId, sleep_id: sleep_id }).unwrap();
            console.log(sleep_id)
