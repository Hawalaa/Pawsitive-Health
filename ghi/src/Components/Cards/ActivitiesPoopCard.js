...
import { useGetPoopHealthQuery, useDeletePoopMutation } from "../../Store/PoopHealthApi";
		...
		return (
			...
			>
				<CardContent sx={{ overflowY: "auto" }}>
							...
							<AccordionDetails>
								<Box
                                    ...
                                    <div>
										...
										<UpdatePoopRecordModal isOpen={isUpdateModalOpen} onClose={closeUpdateModal} selectedPetId={selectedPetId} poop_id={poop.id}/>
                                        <IconButton
                                            aria-label="delete"
											onClick={() => handleDelete(poop.id)}
                                        >
                                            <DeleteIcon />
                                        </IconButton>
                                    </div>
					...
					<AddPoopRecordModal isOpen={isCreateModalOpen} onClose={closeCreateModal} selectedPetId={selectedPetId}/>
				</CardContent>
			</Card>
		);
	} else {
