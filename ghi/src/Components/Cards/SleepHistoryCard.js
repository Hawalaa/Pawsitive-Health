...
import { useGetSleepHistoryQuery, useDeleteSleepMutation } from "../../Store/SleepHistoryApi";
		...
		return (
			...
			>
				<CardContent sx={{ overflowY: "auto" }}>
							...
							<AccordionDetails>
								<Box
                                    ...
                                    <div>
										...
										<UpdateSleepRecordModal isOpen={isUpdateModalOpen} onClose={closeUpdateModal} selectedPetId={selectedPetId} sleep_id={sleep.id}/>
                                        <IconButton
                                            aria-label="delete"
					...
					<AddSleepRecordModal isOpen={isCreateModalOpen} onClose={closeCreateModal} selectedPetId={selectedPetId}/>
				</CardContent>
			</Card>
		);
	} else {
        return (
			...
			>
				<CardContent sx={{ overflowY: "auto" }}>
					<h1 style={{ textAlign: "center" }}>Sleep History</h1>
                    <Divider />
					<h2 style={{ textAlign: "left" }}>No Sleep Data Available...</h2>
                    <Button
                        variant="text"
                        color="primary"
                        sx={{
