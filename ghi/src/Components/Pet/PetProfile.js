...
import { ListItem, ListItemAvatar, Avatar, ListItemText, Grid, Divider, Typography } from '@mui/material';
				...
				>
					...
					>
						<CardContent sx={{ overflowY: "auto" }}>
							<h1 style={{ textAlign: "left" }}>Woof, woof {data.pet_name}!</h1>
							<Divider />
							<Grid container>
								<Grid item key={data.pet_id}>
									<ListItem>
										<ListItemAvatar sx={{ textAlign: "center"}}>
											<Avatar
												alt={data.name}
												src={data.pet_pic ? data.pet_pic : defaultPetPic}
												sx={{ width: 200, height: 200 }}
											/>
											<Typography variant="h5">{data.pet_name}</Typography>
										</ListItemAvatar>
									</ListItem>
